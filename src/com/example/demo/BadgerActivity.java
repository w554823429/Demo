...
import com.example.demo.shortcutbadger.ShortcutBadger;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean success = ShortcutBadger.applyCount(BadgerActivity.this, badgeCount);
        ...
        removeBadgeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean success = ShortcutBadger.removeCount(BadgerActivity.this);
